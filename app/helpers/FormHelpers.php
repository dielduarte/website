<?php
    ...
    {
        $element = Form::select($name, array('' => '-- Selecione --') + $options, $value, fieldAttributes($name, $attributes));
    ...
    Form::macro('sub', function($name, $class = 'btn btn-primary', $size = 'md'){
        return Form::submit($name, array('class' => 'btn btn-' . $class . ' btn-' . $size));
    });
