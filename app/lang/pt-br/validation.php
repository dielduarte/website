...
return array(
    ...
    */
    ...
    "active_url"     => "A URL :attribute nao é valida.",
    "after"          => "A data :attribute deve ser posterior a :date.",
    "alpha"          => "O campo :attribute deve conter somente letras.",
    "alpha_dash"     => "O campo :attribute deve conter somente letras, numeros é travessoes.",
    "alpha_num"      => "O campo :attribute deve conter somente letras é numeros.",
    ...
    "different"      => "O campo :attribute é :other devem ser diferentes.",
    "email"          => "O campo :attribute nao é um email valido.",
    ...
    "match"          => "O formato do campo :attribute é invalido.",
    "max"            => array(
    ...
    "same"           => "O campo :attribute é :other devem ser iguais.",
    "size"           => array(
